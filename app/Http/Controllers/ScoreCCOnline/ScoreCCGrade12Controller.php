...
class ScoreCCGrade12Controller extends Controller
{
    /**
    ...
    {
        $grade=DB::table('v_class')->where('grade','like','%12%')->where('deleted','0')->get();
        $month=DB::table('month')->get();
        return view('score_cc_online.score_cc_online_12')->with('grade',$grade)->       with('month',$month);
    }
    ...
    public function store(Request $request)
    {
        ...
        $db=DB::table('score_cc_online')->where('grade',12)->where('class_id',$request->grade)->where('month_id',$request->month)->count();
        if($request->month==13){
            return "";
        }else if($db==0) {
        ...
        ";
            ...
            foreach ($sql as $row) {
             ...
             <tr class="text-center">
               ...
               <td><input type="text" class=" form-control  polakam" style="text-align: center;font-size: 14px ;width: 5rem " maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td hidden><input type="text" class="month" value="'.$request->month.'"></td>
                <td hidden><input type="text" class="student_id" value="' . $row->id . '"></td>
                <td hidden><input type="text" class="grade" value="12"></td>
        ...
        ";
            ...
            foreach ($sql as $row) {
             ...
             <tr class="text-center">
              <td style="text-align: center">' . $i++ . '</td>
                   <td style="text-align: left"  ><p style="width: 10rem;">'. $row->kh_name . '</p></td>
                <td><input type="text" class=" form-control input-sm khmer" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->khmer . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class=" form-control input-sm polroth" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->polroth . '"  maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class=" form-control input-sm history" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->history . '"  maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class=" form-control input-sm phum" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->phum . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class=" form-control input-sm math" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->math . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class=" form-control input-sm physical" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->physical . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class="form-control input-sm chemistry" style="text-align: center;font-size: 14px  ;width: 5rem" value="'.$row->chemistry.'" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class=" form-control input-sm  biology" style="text-align: center;font-size: 14px ;width: 5rem" value="' . $row->biology . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class=" form-control input-sm phandey" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->phandey . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class="  form-control input-sm english" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->english . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class=" form-control input-sm kehak" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->kehak . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class="form-control input-sm sport" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->sport . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td><input type="text" class=" form-control input-sm polakam" style="text-align: center;font-size: 14px  ;width: 5rem" value="' . $row->polakam . '" maxlength="3" onkeypress="return (event.charCode == 8 || event.charCode == 0 || event.charCode == 13) ? null : event.charCode >= 48 && event.charCode <= 57"/></td>
                <td hidden><input type="text" class="month" value="'.$request->month.'"></td>
        ...
        if ($request->con == 1) {
            ...
            for ($i = 0; $i < count($request->score_id); $i++) {
                DB::table('score_cc_online')->where('id', $request->score_id[$i])
                    ->where('class_id', $request->class_id[$i])->where('month_id', $request->month[$i])->where('grade', 12)
                    ->update(
...
//          ScoreCCOnline::updateOrCreate($insert);
        }
    }
    /**
