        ...
        <div class="col-12">
            ...
            <div class="card ">
               ...
               <div class="card-block">
                <button  style="margin-bottom: 10px" class=" btn btn-primary btn-sm" id="btn_add_new_user">Add New User</button>
                    ...
                    <table id="table_user" class="table table-bordered">
                        ...
                        @foreach($data_user as $d)
                            <tr style="text-align: center">
                                ...
                                <td>
                                    <button class="btn btn-sm btn-warning btn_modal_change" data-id="{{ $d->id }}">Change Password</button>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="confirm_password" aria-describedby="emailHelp" placeholder="Confirm Password">

            </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary" id="btn_save_user"><i class="fa fa-plus"></i> Save User</button>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                <label for="exampleInputEmail1">Password</label>
                <input type="email" class="form-control" id="change_password" aria-describedby="emailHelp" placeholder="Enter Password">

            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Confirm Password</label>
                <input type="email" class="form-control" id="change_confirm_password" aria-describedby="emailHelp" placeholder="Confirm Password">

            </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="button" class="btn btn-primary" id="btn_change_pass"><i class="fa fa-plus"></i> Change Password</button>
        </div>
      </div>
    </div>
  </div>
