            ...
            <div class="card-block">
                <div class="card">
                    ...
                    <div class="card-block">
                        ...
                        &nbsp;
                        <button class="btn btn-sm btn-app-blue" id="btnshow"><i class="fas fa-search"></i>&nbsp;បង្ហាញទិន្នន័យ
                        </button>
                    </div>
                </div>
        ...
        function dts() {
            $('#exps').DataTable({
                ...
                buttons: [
                    ...
                    {extend: 'print', text: '<i class="fa fa-print"></i>&nbsp;ព្រីនទិន្ន័យ'},
            ...
            $('#exp').DataTable({
                ...
                "fnDrawCallback": function (oSettings) {
                    if (oSettings.bSorted || oSettings.bFiltered) {
                        api = this.api();
                        var arr = api.columns(13).data()[0];  //get array of column 1 (extn)
                        ...
                        if (oSettings.bSorted || oSettings.bFiltered) {
                            for (var i = 0, iLen = oSettings.aiDisplay.length; i < iLen; i++) {
                                $('td:eq(14)', oSettings.aoData[oSettings.aiDisplay[i]].nTr).html(ranks[i]);
                            }
                        }
                    }
                },
