        ...
        <div class="card">
            <div class="card-block">
                <div class="card">
                    ...
                    <div class="card-block">
                        <label class="myFont">Class :</label>
                        ...
                        &nbsp;
                        <label class="myFont">Month :</label>
                        ...
                        &nbsp;
                        <button class="btn btn-sm btn-app-blue myFont" id="btnshow"><i class="fas fa-search"></i>&nbsp;Search
                        </button>
                    </div>
                </div>
...
@section('footer')
    ...
    <script>
        $(document).ready(function () {
            $('#save').hide();
            $('.sl2').select2({ dropdownCssClass: "myFont" });
        });
    </script>
    <script>
